...
- **Rust/Native** (experimental, `--native` or `NSTBROWSER_AI_AGENT_NATIVE=1`) -- `cli/src/native/daemon.rs`, `cli/src/native/actions.rs`, `cli/src/native/browser.rs`, and the rest of `cli/src/native/`
