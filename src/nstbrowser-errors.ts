...
import { ERROR_CODES, DEFAULT_NST_PORT, LOCALHOST_IP, API_PROFILES } from './constants.js';
...
export class NstbrowserNotInstalledError extends NstbrowserError {
  constructor() {
    super('Nstbrowser client is not installed', ERROR_CODES.NST_NOT_INSTALLED);
  }
}

export class NstbrowserNotRunningError extends NstbrowserError {
  constructor() {
    super('Nstbrowser client is not running', ERROR_CODES.NST_NOT_RUNNING);
  }
}

export class NstbrowserAuthError extends NstbrowserError {
  constructor() {
    super('Invalid Nstbrowser API key', ERROR_CODES.NST_AUTH_ERROR, 401);
  }
}

export class NstbrowserProfileNotFoundError extends NstbrowserError {
  constructor(profileName: string) {
    super(`Profile '${profileName}' not found`, ERROR_CODES.NST_PROFILE_NOT_FOUND, 404);
  }
}

export class NoProfileSpecifiedError extends NstbrowserError {
  constructor() {
    super('No profile specified', ERROR_CODES.NO_PROFILE_SPECIFIED);
  }
}

export class NstbrowserConnectionError extends NstbrowserError {
  constructor(message: string) {
    super(`Failed to connect to Nstbrowser: ${message}`, ERROR_CODES.NST_CONNECTION_ERROR);
  }
}
