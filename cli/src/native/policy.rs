...
impl ConfirmActions {
    pub fn from_env() -> Option<Self> {
        let val = env::var("NSTBROWSER_AI_AGENT_CONFIRM_ACTIONS").ok()?;
        if val.is_empty() {
            return None;
        }
...
mod tests {
    ...
    fn test_confirm_actions_from_env() {
        env::set_var("NSTBROWSER_AI_AGENT_CONFIRM_ACTIONS", "navigate,click,fill");
        ...
        env::remove_var("NSTBROWSER_AI_AGENT_CONFIRM_ACTIONS");
    }
}
